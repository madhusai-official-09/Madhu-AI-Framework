...
export const useChatStore = create<ChatState>()((set, get) => ({
  ...
  hydrateFromHistory: (messages:{role: "user"|"assistant";content: string;}[],) => {
    ...
    const restoredMessages: ChatMessage[] = validMessages.map(
      (message, index) => ({
        id: genId(),
        role: message.role,
    ...
    const firstUserMessage = restoredMessages.find(
